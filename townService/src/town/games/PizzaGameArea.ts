...
export default class PizzaPartyGameArea extends GameArea<PizzaPartyGame> {
  ...
  private _stateUpdated(updatedState: GameInstance<PizzaPartyGameState>) {
   ...
   * - Any command besides JoinFGame, GameMove, StartGame and LeaveGame: INVALID_COMMAND_MESSAGE
   */
