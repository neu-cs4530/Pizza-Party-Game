...
import PizzaPartyAreaController from './interactable/PizzaPartyAreaController';
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      this._socket.on('initialize', initialData => {
        ...
        initialData.interactables.forEach(eachInteractable => {
          ...
          } else if (isPizzaPartyArea(eachInteractable)) {
            this._interactableControllers.push(
              new PizzaPartyAreaController(eachInteractable.id, eachInteractable, this),
            );
          }
        });
